-- ============================================================================
-- 07-df08-close-fix.sql — W6.2 LAB · DF-08 CLOSE PRODUCTION ORDER (uuid=uuid)
-- Diseño: W62-04 DF-08. Requiere 01-06. FIX de UNA expresión:
--   idempotencia: WHERE ... record_id = p_order_id (uuid = uuid, SIN ::text)
-- El workaround «cerrar sin key» queda RECHAZADO como solución permanente.
-- ============================================================================
...
\echo '07: DF-08 aplicado — idempotencia uuid=uuid (sin cast ::text); workaround sin key queda como puente NO permanente'
