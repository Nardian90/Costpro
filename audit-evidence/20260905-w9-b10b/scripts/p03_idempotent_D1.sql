-- B-10b probe: R3 idempotent D1(2nd) (esperado: ERR_ALREADY_REVERSED, 0 cambios)
...
BEGIN
  ...
  BEGIN
    v_res := public.reverse_devolution('deafe436-ab12-404c-9975-b519623a8da9', 'R3 idempotent D1(2nd)', NULL);
  ...
  INSERT INTO b10b_probe VALUES ('result', jsonb_build_object(
    'probe', 'R3 idempotent D1(2nd)', 'expected', 'ERR_ALREADY_REVERSED, 0 cambios',
