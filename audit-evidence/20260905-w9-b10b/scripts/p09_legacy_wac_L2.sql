-- B-10b probe: R9 legacy L2 (U1) (esperado: SUCCESS uc=7 (cost_average fallback) stock P4 -1)
...
BEGIN
  ...
  BEGIN
    v_res := public.reverse_devolution('b10b0000-0000-4000-8000-0000000003b2', 'R9 legacy L2 (U1)', NULL);
  ...
  INSERT INTO b10b_probe VALUES ('result', jsonb_build_object(
    'probe', 'R9 legacy L2 (U1)', 'expected', 'SUCCESS uc=7 (cost_average fallback) stock P4 -1',
