...
const sql=fs.readFileSync('/home/z/my-project/Costpro/supabase/migrations/20260905000001_w9_b8_modelo_c_undo_reverse_authorization.sql','utf8');
(async()=>{
  ...
  console.log(body.length>4000?body.slice(0,4000)+'...[trunc]':body);
