-- ============================================================================
-- ROLLBACK REM-F4-04 — restores register_reception to its PRE-gate definition
-- (captured 2026-09-09 via pg_get_functiondef BEFORE migration
--  20260909000000_rem_f4_04_register_reception_canonical_wac.sql was applied).
-- NOT EXECUTED in the gate run. Only for emergency decision by the principal.
-- ============================================================================
