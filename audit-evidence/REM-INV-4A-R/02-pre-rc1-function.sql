-- VERBATIM LIVE capture 2026-09-13
...
-- ===== FULL pg_get_functiondef (header included), captured 2026-09-14 PRE-fix =====
-- md5(prosrc)=7edb09b6b6f83b6d943e6171acf3412c
-- NOTE: the complete header-bearing definition is in the section below and in
-- supabase/migrations/20260915000001 (PRE == pre-surgery version).
