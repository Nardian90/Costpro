...
system_health_view = r"""'use client';
...
architecture_audit_table = r"""'use client';
...
with open('src/components/views/terminal/views/health/SystemHealthView.tsx', 'w') as f:
    f.write(system_health_view)

with open('src/components/views/terminal/views/health/ArchitectureAuditTable.tsx', 'w') as f:
    f.write(architecture_audit_table)
