...
export const managedCreateUserSchema = z.object({
  ...
  p_store_id: z.preprocess((val) => (val === '' ? null : val), z.string().uuid('store_id inválido').nullable().optional()),
...
export const reportsGenerateSchema = z.object({
  ...
  definition_id: z.preprocess((val) => (val === '' ? undefined : val), z.string().uuid().optional()),
