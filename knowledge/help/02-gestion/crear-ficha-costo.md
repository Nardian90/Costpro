...
- [1. Iniciar una Nueva Ficha de Costo](#1-iniciar-una-nueva-ficha-de-costo)
  - [Desde el Explorador de Plantillas](#desde-el-explorador-de-plantillas)
  - [Desde la Vista de Fichas](#desde-la-vista-de-fichas)
- [2. Completar el Encabezado](#2-completar-el-encabezado)
- [3. Construir la Estructura de Secciones](#3-construir-la-estructura-de-secciones)
  - [Estructura del Árbol](#estructura-del-árbol)
  - [Operaciones con Filas](#operaciones-con-filas)
- [4. Ingresar Costos](#4-ingresar-costos)
  - [Valor Histórico (Valor Fijo)](#valor-histórico-valor-fijo)
  - [Fórmulas](#fórmulas)
- [5. Configurar Métodos de Cálculo](#5-configurar-métodos-de-cálculo)
  - [Cómo Configurar](#cómo-configurar)
- [6. Configurar Anexos](#6-configurar-anexos)
  - [Crear un Anexo](#crear-un-anexo)
  - [Agregar Datos al Anexo](#agregar-datos-al-anexo)
  - [Vincular un Anexo a una Sección](#vincular-un-anexo-a-una-sección)
  - [Coeficiente de Anexo](#coeficiente-de-anexo)
- [7. Tabla de Referencia de Fórmulas](#7-tabla-de-referencia-de-fórmulas)
  - [Sintaxis](#sintaxis)
  - [Fórmulas Típicas de la Ficha](#fórmulas-típicas-de-la-ficha)
- [8. Flujo de Costos](#8-flujo-de-costos)
- [9. Usar el Solver (KPI Tablero)](#9-usar-el-solver-kpi-tablero)
  - [Cómo Funciona](#cómo-funciona)
  - [Ejemplo Práctico](#ejemplo-práctico)
- [10. Revisar en Modo Auditoría](#10-revisar-en-modo-auditoría)
- [11. Modos de Vista Disponibles](#11-modos-de-vista-disponibles)
- [12. Guardar y Exportar](#12-guardar-y-exportar)
  - [Guardar la Ficha](#guardar-la-ficha)
  - [Exportar](#exportar)
  - [Importar una Ficha Existente](#importar-una-ficha-existente)
...
1. Navega al **KPI Tablero** de la ficha de costo
