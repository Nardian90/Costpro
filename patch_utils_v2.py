...
# Refined search for recalculateIPVReportsChain logic
search_block = """            // Entradas inteligentes para este producto en esta fecha
...
replace_block = """            // Sumar todas las entradas registradas en product_movements para esta fecha
