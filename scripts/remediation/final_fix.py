...
write_file('src/components/views/terminal/views/health/SystemHealthView.tsx', health_view)
write_file('src/components/views/terminal/views/health/ArchitectureAuditTable.tsx', architecture_audit_table)

print("Files rewritten with explicit types.")
