...
export default function WelcomeLandingView({ onLoginClick }: WelcomeLandingViewProps) {
  ...
  return (
    <div className="bg-background text-on-surface font-sans selection:bg-primary selection:text-on-primary min-h-screen">
      {/* Top Navigation */}
      <nav className="fixed top-0 w-full z-50 bg-slate-950/80 backdrop-blur-xl border-b border-outline-variant/10">
        <div className="flex justify-between items-center max-w-7xl mx-auto px-6 h-20">
          <div className="text-2xl font-black tracking-tighter text-slate-100 flex items-center gap-2 font-headline">
          ...
          <div className="hidden md:flex items-center gap-8 font-semibold tracking-tight">
            ...
            <button onClick={goToHelpSlideshow} className="text-slate-400 hover:text-slate-100 transition-colors">Seguridad</button>
            <button onClick={goToHelpSlideshow} className="text-slate-400 hover:text-slate-100 transition-colors">Integraciones</button>
            <button onClick={goToHelpSlideshow} className="text-slate-400 hover:text-slate-100 transition-colors">Casos de Riesgo</button>
          </div>
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className={cn(
                ...
                isInstallable ? "bg-primary text-on-primary" : "text-slate-400 border border-outline-variant/20"
              )}
            >
              <Download className="w-4 h-4" />
              <span className="hidden lg:inline">APP</span>
            </button>
            <button onClick={onLoginClick} className="hidden lg:block text-slate-400 font-semibold px-4 py-2 hover:text-slate-100 transition-colors">Login</button>
      ...
      <main className="pt-20">
          ...
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
            <div className="z-10">
              <motion.div
                ...
                className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-red-500/10 border border-red-500/30 mb-6"
              >
                <span className="w-2 h-2 rounded-full bg-red-500 animate-pulse"></span>
                <span className="text-[10px] font-bold uppercase tracking-widest text-red-400">Alerta de Integridad Financiera</span>
              </motion.div>
              <motion.h1
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.1 }}
                className="text-5xl md:text-6xl lg:text-7xl font-black tracking-tighter leading-[0.95] text-slate-100 mb-8 font-headline"
              >
                Tu contabilidad <span className="text-red-500">NO coincide</span> con tu banco. Y eso te cuesta dinero hoy.
              </motion.h1>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.2 }}
                className="text-xl text-on-surface-variant max-w-lg mb-10 leading-relaxed font-sans"
              >
              ...
              >
                ...
                <button
                  ...
                  className="border border-outline-variant px-8 py-4 rounded font-bold hover:bg-surface-container transition-all uppercase tracking-widest text-sm"
                >
            ...
            >
              ...
              <div className="relative glass-panel border border-red-500/30 rounded-xl p-4 shadow-2xl overflow-hidden terminal-glow">
                <div className="flex items-center justify-between mb-4 border-b border-outline-variant/20 pb-2">
                  ...
                  <div className="text-[10px] font-mono text-red-400 uppercase tracking-widest font-bold">SISTEMA_CRÍTICO : DISCREPANCIA</div>
                </div>
                <div className="bg-black/60 rounded p-6 font-mono text-sm space-y-4">
                  ...
                  <div className="pt-2 border-t border-outline-variant/10">
                    ...
                    <div className="flex justify-between text-white font-bold mt-1">
                      <span>$2,450.40</span>
                      <span>$2,850.40</span>
                      <span className="text-red-400">-$400.00</span>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <section className="py-24 px-6 bg-surface-container-low border-y border-outline-variant/10">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-black text-slate-100 uppercase tracking-tight font-headline">Calculadora de Fuga Operativa</h2>
              <p className="text-on-surface-variant font-sans mt-2">Dimensiona el impacto de tu ceguera financiera actual.</p>
            </div>
            <div className="grid md:grid-cols-2 gap-8 bg-surface-container-highest p-8 rounded border border-outline-variant/30 monospaced-data">
              <div className="space-y-6">
                <div>
                  <label className="block text-xs text-primary font-bold mb-2 uppercase tracking-widest">Ingresos Mensuales ($)</label>
                  <input
                    className="w-full bg-background border border-outline-variant rounded p-3 text-white focus:border-primary focus:ring-1 focus:ring-primary outline-none"
                    type="number"
                    value={revenue}
              ...
              <div className="bg-black/40 rounded p-6 flex flex-col justify-between border border-primary/20">
                <div>
                  ...
                  <div className="text-4xl font-bold text-red-400">
                    ...
                    <span className="text-sm font-normal text-slate-400 ml-2">/ mes</span>
                  </div>
                </div>
        ...
        <section className="py-24 px-6">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
            <div className="md:w-1/2">
              <h2 className="text-4xl md:text-5xl font-black tracking-tight text-slate-100 mb-6 font-headline leading-tight">El dinero que estás perdiendo no aparece en tus reportes.</h2>
              <p className="text-xl text-on-surface-variant font-sans mb-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 p-4 bg-surface-container rounded border-l-4 border-red-500">
                  <XCircle className="w-6 h-6 text-red-500 flex-shrink-0" />
                  <div>
                    <h4 className="text-white font-bold mb-1">Márgenes Falsos</h4>
                    <p className="text-sm text-on-surface-variant">Confiar en el saldo contable sin validar el extracto bancario minuto a minuto genera una ilusión de rentabilidad.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 bg-surface-container rounded border-l-4 border-primary">
                  <History className="w-6 h-6 text-primary flex-shrink-0" />
                  <div>
                    <h4 className="text-white font-bold mb-1">Latencia de Decisión</h4>
                    <p className="text-sm text-on-surface-variant">Conciliar mensualmente significa que descubres problemas 30 días después de que ocurrieron. Demasiado tarde para recuperar el dinero.</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="md:w-1/2 grid grid-cols-2 gap-4">
              <div className="bg-surface-container-high p-6 border border-red-500/20 rounded text-center">
                <div className="text-red-400 font-mono text-xs mb-2">ERROR_HUMANO_AVG</div>
                <div className="text-4xl font-bold font-mono text-white">4.2%</div>
                <div className="text-[10px] text-slate-500 mt-2 uppercase">De facturación total</div>
              </div>
              <div className="bg-surface-container-high p-6 border border-outline-variant/30 rounded text-center">
                <div className="text-outline font-mono text-xs mb-2">TIEMPO_CONTABLE</div>
                <div className="text-4xl font-bold font-mono text-white">120h</div>
              ...
              <div className="col-span-2 bg-red-500/5 p-8 border border-red-500/20 rounded">
                <h4 className="text-white font-bold mb-3 text-lg uppercase tracking-tight">Riesgo Operativo Inminente</h4>
                <p className="text-sm text-on-surface-variant leading-relaxed italic">"Si tu información financiera tiene más de 24 horas de retraso, no estás dirigiendo una empresa; estás reaccionando a un pasado que ya no puedes cambiar."</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* IPV MECHANISM */}
        <section className="py-32 px-6 bg-surface-container-low border-y border-outline-variant/10">
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-20">
              ...
              <h2 className="text-4xl font-black text-slate-100 font-headline uppercase tracking-tight">Protocolo de Validación de Integridad (IPV)</h2>
              <p className="text-on-surface-variant font-sans max-w-2xl mx-auto mt-4">No usamos IA como buzzword. Auditamos matemáticamente cada flujo de dinero.</p>
            </div>
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-surface-container-high border border-outline-variant/20 p-8 rounded group">
                <div className="monospaced-data text-xs text-primary mb-4 font-bold">01. INPUT</div>
                <h3 className="text-xl font-bold text-white mb-4 font-headline">Ingesta de Datos Crudos</h3>
                <p className="text-sm text-on-surface-variant leading-relaxed">Conexión directa via API con bancos, terminales POS y ERP. Eliminamos la manipulación humana en la carga de datos.</p>
              </div>
              <div className="bg-primary/5 border border-primary/20 p-8 rounded relative overflow-hidden group">
                ...
                <h3 className="text-xl font-bold text-white mb-4 font-headline">Cruce de Transacciones</h3>
                <p className="text-sm text-on-surface-variant leading-relaxed">Cruzamos cada transacción bancaria contra tu estructura de costos específica. El motor detecta discrepancias a nivel de sub-centavo en milisegundos.</p>
              ...
              <div className="bg-surface-container-high border border-outline-variant/20 p-8 rounded group">
                ...
                <h3 className="text-xl font-bold text-white mb-4 font-headline">Justificación Técnica</h3>
                <p className="text-sm text-on-surface-variant leading-relaxed">Alertas accionables con causa probable. Cada error tiene un log de auditoría inmutable para cierres contables sin fricción.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-32 px-6">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-4xl font-black text-slate-100 font-headline text-center mb-16 uppercase tracking-tight">Realidad vs. Protocolo COSTPRO</h2>
            <div className="grid md:grid-cols-2 gap-1px bg-outline-variant/20 border border-outline-variant/20 rounded overflow-hidden">
              <div className="bg-surface-container p-12">
                <h4 className="text-red-400 font-mono text-xs font-bold mb-8 uppercase tracking-widest">Estado Actual: Vulnerable</h4>
              ...
              <div className="bg-surface-container-highest p-12 border-l border-outline-variant/10">
        ...
        <section className="py-24 px-6 bg-red-950/20 border-y border-red-900/30">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-5xl font-black tracking-tight text-white mb-6 font-headline leading-tight">Si tus datos financieros están retrasados, tus decisiones son incorrectas.</h2>
            ...
            <button
              onClick={onLoginClick}
              className="bg-white text-black font-bold px-12 py-5 rounded text-lg hover:bg-slate-200 transition-all uppercase tracking-tighter"
            >
        ...
        <section className="py-32 px-6 text-center bg-gradient-to-b from-background to-primary/10">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl md:text-7xl font-black tracking-tighter text-slate-100 mb-8 font-headline leading-none uppercase">
              Blindaje de Flujo de Caja.
            </h2>
            <p className="text-xl text-on-surface-variant mb-12 font-sans italic">Acceso limitado a empresas con facturación &gt;$500k/mes.</p>
      ...
      {/* Footer */}
      <footer className="bg-slate-950 w-full border-t border-slate-900 pt-12 pb-8">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <div className="text-xl font-bold text-slate-100 font-headline mb-4 uppercase tracking-tighter flex items-center gap-2">
