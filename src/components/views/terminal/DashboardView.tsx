...
import { useDashboardData, useProducts } from '@/hooks/useQueries';
...
export default function DashboardView({ onViewInventory }: DashboardViewProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <StateRenderer
        isLoading={isLoadingDashboard || isLoadingProducts}
        error={dashboardError || productsError}
        data={dashboardData ? [dashboardData] : []} // StateRenderer expects an array
      >
        {(data) => {
          ...
          return (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <DashboardAlertsSection products={products} onViewInventory={onViewInventory} />
            </div>
          );
        }}
      </StateRenderer>
