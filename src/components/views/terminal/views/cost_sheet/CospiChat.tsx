        ...
        <div className={cn(
            ...
            <div className={cn(
                ...
                <div className="flex items-center gap-3">
                    <div className={cn(
                        ...
                        isDark ? "bg-[hsl(var(--primary))]/10 border-[hsl(var(--primary))]/30" : "bg-primary/10 border-primary/20"
                    )}>
                        <Bot className={cn("w-5 h-5", isDark ? "text-[hsl(var(--primary))]" : "text-primary")} />
                    </div>
                    <div>
                        <h4 className={cn(
                            "text-[10px] font-black uppercase tracking-[0.3em] leading-none mb-1",
                            isDark ? "text-[hsl(var(--primary))]/60" : "text-primary/60"
                        )}>Cospi AI</h4>
                ...
                {onToggleFullView && (
                    <button
                        ...
                        className={cn(
                            ...
                            isDark ? "hover:bg-white/10 text-[hsl(var(--primary))]/50 hover:text-[hsl(var(--primary))]" : "hover:bg-primary/10 text-primary/50 hover:text-primary"
                        )}
                ...
                {messages.length === 0 && (
                    <div className="h-full flex flex-col items-center justify-center text-center p-6 space-y-4 opacity-40">
                        <div className={cn(
                            ...
                            isDark ? "border-[hsl(var(--primary))]/30" : "border-primary/30"
                        )}>
                            <MessageSquare className={cn("w-6 h-6", isDark ? "text-[hsl(var(--primary))]" : "text-primary")} />
                        </div>
                        <div>
                ...
                {messages.map((msg, i) => (
                    <div key={i} className={cn("flex w-full", msg.role === 'user' ? "justify-end" : "justify-start")}>
                        <div className={cn(
                            ...
                            msg.role === 'user'
                                ? (isDark ? "bg-[hsl(var(--primary))] text-black rounded-tr-none shadow-[hsl(var(--primary))]/10" : "bg-primary text-white rounded-tr-none shadow-primary/10")
                ...
                {isLoading && (
                    <div className="flex justify-start">
                        <div className={cn(
                            ...
                            <Loader2 className={cn("w-4 h-4 animate-spin", isDark ? "text-[hsl(var(--primary))]" : "text-primary")} />
            ...
            <div className={cn(
                ...
                <div className={cn(
                    ...
                    isDark ? "bg-white/5 border-white/10 focus-within:border-[hsl(var(--primary))]/50" : "bg-white border-border focus-within:border-primary/50"
                )}>
                    <input
                        value={input}
                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            isDark ? "bg-[hsl(var(--primary))] text-black shadow-[hsl(var(--primary))]/20" : "bg-primary text-white shadow-primary/20"
                        )}
                    >
