        ...
        <div className="flex items-center gap-2">
            {onOpenActions && (
                <button
                    ...
                    className="neu-raised-sm bg-card hover:bg-muted w-11 h-11 text-foreground flex items-center justify-center shrink-0 active:scale-90 transition-transform"
                    aria-label="Abrir menú de acciones"
                >
                    <Menu className="w-6 h-6 text-foreground stroke-[2.5]" />
                </button>
            )}
            <Button
              variant="outline"
