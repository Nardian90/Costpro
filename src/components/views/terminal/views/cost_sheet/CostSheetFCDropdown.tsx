...
export function CostSheetFCDropdown({
  ...
  const options = [
    ...
    { id: 'all-content', label: 'Todo', icon: Zap }, // Renamed from Experto
  ];
        ...
        {options.map((opt) => (
          <DropdownMenuItem
            ...
            className={cn(
              ...
              isOptionActive(opt.id) ? "bg-primary/10 text-primary font-bold" : "text-muted-foreground hover:bg-muted"
            )}
          >
