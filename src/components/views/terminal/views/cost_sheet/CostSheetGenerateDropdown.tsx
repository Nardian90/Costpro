    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        ...
        >
          ...
          <span className="text-xs font-black uppercase tracking-widest text-primary group-hover:text-primary transition-colors">
            Generar
          </span>
      ...
      <DropdownMenuContent align="end" className="w-56 p-2 rounded-2xl bg-card border-border shadow-2xl">
        ...
        <DropdownMenuItem onClick={onQuickGenerate} className="flex items-center gap-3 px-3 py-2.5 rounded-xl cursor-pointer">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-muted-foreground uppercase font-medium">Preconfigurado</span>
          </div>
        </DropdownMenuItem>
        <DropdownMenuItem onClick={onExpertGenerate} className="flex items-center gap-3 px-3 py-2.5 rounded-xl cursor-pointer">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-muted-foreground uppercase font-medium">Masivo Avanzado</span>
          </div>
        </DropdownMenuItem>
      </DropdownMenuContent>
    </DropdownMenu>
