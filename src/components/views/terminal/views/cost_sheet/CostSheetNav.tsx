  ...
  const navActions: Action[] = React.useMemo(() => {
    ...
    const mainNavItems = navItems.filter(s => !['massive-gen', 'kpis', 'templates', 'ai-chat'].includes(s.id));
        ...
        const actions: Action[] = [
        {
            ...
            icon: Menu,
            className: "neu-raised-sm w-11 h-11 flex items-center justify-center shrink-0 active:scale-90 transition-transform text-primary dark:text-primary hover:bg-primary/10",
