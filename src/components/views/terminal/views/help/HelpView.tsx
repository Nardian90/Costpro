      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-primary/10 pb-6">
        ...
        <div className="flex flex-col items-end">
          <Badge variant="outline" className="bg-primary/5 text-primary border-primary/20 font-black">
            VERSIÓN 5.6.3 (MOBILE UX OPTIMIZATION)
          </Badge>
          <span className="text-[10px] text-muted-foreground font-bold uppercase mt-1">Última actualización: 16 Feb 2026</span>
        </div>
      </div>
            ...
            <CardContent className="px-0">
              <div className="space-y-8">
                ...
                <div className="relative pl-8 border-l-2 border-primary/20 space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    <Badge className="bg-primary">v5.6.3</Badge>
                    <span className="text-xs font-black text-muted-foreground uppercase">16 de Febrero, 2026 (Actual)</span>
                  </div>
