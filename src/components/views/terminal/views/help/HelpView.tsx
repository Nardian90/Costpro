      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-primary/10 pb-6">
        ...
        <div className="flex flex-col items-end">
          <Badge variant="outline" className="bg-primary/5 text-primary border-primary/20 font-black">
            VERSIÓN 5.7.10 (UX STRATEGIC)
          </Badge>
          <span className="text-[10px] text-muted-foreground font-bold uppercase mt-1">Última actualización: 23 Feb 2026</span>
        </div>
      </div>
            ...
            <CardContent className="px-0">
              <div className="space-y-8">
                ...
                <div className="relative pl-8 border-l-2 border-primary/20 space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    <Badge className="bg-primary">v5.7.10</Badge>
                    <span className="text-xs font-black text-muted-foreground uppercase">23 de Febrero, 2026 (Actual)</span>
                  </div>
                  <div className="bg-muted/30 rounded-2xl p-6 space-y-4 border border-primary/10 shadow-sm">
                    <h4 className="font-black text-sm uppercase text-primary">Optimización Estratégica de UX Móvil y TPV</h4>
                    <ul className="grid md:grid-cols-2 gap-x-8 gap-y-2 text-xs font-medium text-muted-foreground">
                      <li className="flex gap-2 items-center"><CheckCircle2 className="w-3 h-3 text-emerald-500" /> <strong>Sticky Checkout:</strong> Footer de caja siempre visible en la zona del pulgar.</li>
                      <li className="flex gap-2 items-center"><CheckCircle2 className="w-3 h-3 text-emerald-500" /> <strong>Flujo de Alta Velocidad:</strong> Reducción de scroll excesivo en carritos con múltiples items.</li>
                      <li className="flex gap-2 items-center"><CheckCircle2 className="w-3 h-3 text-emerald-500" /> <strong>Thumb Zone Hardening:</strong> Todos los botones primarios cumplen el estándar de 44px.</li>
                      <li className="flex gap-2 items-center"><CheckCircle2 className="w-3 h-3 text-emerald-500" /> <strong>Feedback Visual:</strong> Sombras y estados activos mejorados para operativa táctil.</li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="relative pl-8 border-l-2 border-primary/20 space-y-4 opacity-80">
                  ...
                  <div className="flex items-center gap-3">
                    <Badge variant="outline">v5.6.2</Badge>
                    <span className="text-xs font-black text-muted-foreground uppercase">15 de Febrero, 2026</span>
                  </div>
