                                ...
                                <Card key={g.month} className="p-4 hover:shadow-md transition-all group relative overflow-hidden flex flex-col gap-3 rounded-xl">
                                    ...
                                    <div className="space-y-2 pt-2 border-t">
                                        {isEditing ? (
                                            ...
                                            <div className="space-y-2">
                                                <div className="flex justify-between items-baseline cursor-pointer" onClick={() => setEditingGoal({month: g.month, amount: (simulations[g.month] || g.goalAmount).toString(), strategy: g.strategy || "MIN_STOCK"})}>
