...
import { AccountingIntegrityReport } from "./AccountingIntegrityReport";
import {
  Table,
  TableBody,
  TableCell,
      ...
      <Tabs defaultValue="integrity" className="w-full">
        <div className="flex justify-between items-center mb-6">
            <TabsList className="bg-muted/50 p-1 rounded-2xl h-12">
                <TabsTrigger value="integrity" className="rounded-xl px-6 data-[state=active]:bg-background data-[state=active]:shadow-sm gap-2 font-black uppercase text-[10px] tracking-widest">
                    <ShieldCheck className="w-4 h-4" />
                    Integridad Contable
                </TabsTrigger>
                <TabsTrigger value="engine" className="rounded-xl px-6 data-[state=active]:bg-background data-[state=active]:shadow-sm gap-2 font-black uppercase text-[10px] tracking-widest">
        ...
        <TabsContent value="engine" className="mt-0 space-y-8">
            {/* Header */}
