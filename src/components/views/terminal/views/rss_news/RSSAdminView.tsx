...
export default function RSSAdminView() {
  ...
  const handleAddFeed = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setNewFeedUrl('');
      setNewFeedName('');
      toast.success('Feed añadido correctamente');
    } catch (err: any) {
      toast.error('Error al añadir feed: ' + err.message);
    }
  };
  ...
  const handleDeleteFeed = async (id: string) => {
    if (!confirm('¿Estás seguro de eliminar este feed?')) return;
    try {
