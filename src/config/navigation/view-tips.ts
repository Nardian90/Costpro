...
export const VIEW_TIPS: Record<string, string> = {
  ...
  'massive-gen': 'Generación en lote: importa tu Excel y mapea columnas',
  'steel-calculator': 'Calcula perfiles de acero con precios actualizados',
  'tool-save-cloud': 'Guardar Ficha persiste la ficha en tu librería (⌘S)',
  'tool-save': 'Exportar JSON descarga un archivo local de la ficha',
  ...
  'sales-hub': 'Vender, Caja e Historial al frente; el resto en Otras opciones',
