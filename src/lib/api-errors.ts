...
export const API_ERRORS = {
  ...
  FC_INVALIDATE_FAILED: { key: 'apiErrors.fcInvalidateFailed', status: 500, defaultMessage: 'Error al invalidar fichas de costo' },
  MEMBERSHIP_BULK_FAILED: { key: 'apiErrors.membershipBulkFailed', status: 500, defaultMessage: 'Error en asignación masiva de miembros' },
  AUDIT_QUERY_FAILED: { key: 'apiErrors.auditQueryFailed', status: 500, defaultMessage: 'Error al consultar auditoría' },
