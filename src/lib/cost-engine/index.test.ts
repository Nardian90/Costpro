  ...
  const mockFicha: FichaJSON = {
    ...
    rows: [
      ...
      },
      {
        ...
        coeficiente: 0.2,
        base_ref: { type: 'FILA', classification: '1.1' }
      }
    ]
  };
        ...
        rows: [
            {
                ...
                calculation_method: 'COEFICIENTE',
                coeficiente: 0.5,
                base_ref: { type: 'FILA', classification: 'B' }
            },
            {
                id: 'b',
                classification: 'B',
                ...
                base_ref: { type: 'FILA', classification: 'A' }
            }
        ]
    };
        ...
        rows: [
            {
                ...
                label: 'Bad',
                calculation_method: 'COEFICIENTE',
                base_ref: { type: 'FILA', classification: 'NON_EXISTENT' }
            }
        ]
    };
