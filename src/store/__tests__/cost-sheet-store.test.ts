...
describe('cost-sheet-store', () => {
  ...
  it('should add a row to an empty annex correctly', () => {
    ...
    expect(annexI?.data[0].description).toBe('');
    expect(annexI?.data[0].price).toBe(0);
  });
