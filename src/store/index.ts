...
export type ViewType = 'occ' | 'dashboard' | 'wallet' | 'pos' | 'inventory' | 'recepcion' | 'reception_list' | 'transferencias' | 'sales' | 'inventory_count' | 'cost-sheets' | 'reports' | 'catalog' | 'history' | 'inventory_adjustments' | 'audit' | 'cash' | 'users' | 'roles' | 'stores' | 'storefront-config' | 'settings' | 'help' | 'wiki' | 'news' | 'rss_management' | 'management-hub' | 'ipv' | 'academy' | 'legal' | 'health' | 'pick3-intelligence' | 'labels' | 'sales_catalog' | 'ofertas' | 'purchase-orders' | 'sales-hub' | 'exchange-intelligence' | 'received-services' | 'usage-monitoring' | 'workers' | 'chat' | 'costeo-dinamico' | 'estructura-costo' | 'whatsapp-config' | 'whatsapp-conversations' | 'whatsapp-invitations' | 'whatsapp-dashboard' | 'whatsapp-group' | 'whatsapp-hub' | 'telegram-config' | 'telegram-conversations' | 'telegram-invitations' | 'telegram-dashboard' | 'telegram-group' | 'telegram-hub' | 'accounts_payable' | 'accounts_receivable' | 'cash_report' | 'production-orders' | 'devolutions' | 'customers' | 'quotations' | 'fiscal-close' | 'lots' | 'warehouses' | 'abc-analysis' | 'bank-reconciliation'
