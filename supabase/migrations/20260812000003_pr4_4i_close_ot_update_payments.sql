-- ============================================================================
-- PR-4.4I — Modificar close_production_order_v2 (PATH B: service)
--
-- Cambio: en lugar de INSERT copia de payment_transactions, hace UPDATE
-- para asociar los pagos existentes con la nueva transaction_id.
-- Esto evita duplicación de filas y preserva la trazabilidad.
-- ============================================================================
...
COMMENT ON FUNCTION public.close_production_order_v2 IS
  'PR-4.4I v2.2.2-R7.2.1: Atomic close. PATH B (service) now UPDATEs payment_transactions
   SET transaction_id (no INSERT copy). Preserves single source of truth for payments.
   Validates I1c (SUM <= budget_total). Logs OT_SALDO_PENDING if partial payment.';
