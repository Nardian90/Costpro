...
# Update res148 layout to match image.png better
res148_new = r"""  // --- 3. Res 148 ---
    ...
    let y = 22;
    // FC Logo simulation or actual logo
    doc.setFontSize(24);
...
content = re.sub(r'// --- 3. Res 148 ---.*?margin: { left: 14, right: 14 },\s+ \}\); \s+ \}', res148_new, content, flags=re.DOTALL)
